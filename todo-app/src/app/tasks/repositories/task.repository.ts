...
export class TaskRepository {
  ...
  create(task: ITask): Promise<ITask> {
    return this.httpClient
      .post<ITask | any>(`${environment.api}/tasks`, task)
      .toPromise();
  }
  ...
  update(entity: ITask): Promise<ITask> {
    ...
    return this.httpClient
      .put<ITask | any>(`${environment.api}/tasks/${id}`, data)
      .toPromise();
  }

  getById(id: string): Promise<ITask> {
    return this.httpClient
      .get<ITask | any>(`${environment.api}/tasks/${id}`)
      .toPromise();
  }

  getAll(): Promise<ITask[]> {
    return this.httpClient
      .get<ITask[] | any>(`${environment.api}/tasks/`)
      .toPromise();
  }
